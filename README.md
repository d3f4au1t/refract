...
As the leading glass edge crosses the central flare, the exposed light dims over a short distance while a soft bloom and luminous rim catch on the edge. A feathered CSS mask preserves only the self-lit “REFR” lettering; the dark “ACT” lettering disappears with the exposed light. Only the “REFR” lettering remains visible and blurred through the glass; the rays and “ACT” are excluded from that surface. The effect follows scroll position in both directions, restoring the rays and “ACT” as the source emerges.
